...
class NET3(nn.Module):
    def __init__(self):
        ...
        self.CNN_layers = nn.Sequential(
            ...
            nn.Conv2d(in_channels=3, out_channels=96, kernel_size=3 ,stride=1),
            nn.ReLU(),
        ...
        self.linear_layers = nn.Sequential(
            nn.Linear(in_features=1*1*128, out_features=1024),
            nn.ReLU(),
            nn.Dropout(0.5),
            ...
            nn.ReLU(),
            nn.Dropout(0.5),
            # The output is 10 which should match the size of our class.
...
# Eğitim sırasında model ağırlıklarını ayarlarken çapraz entropi kaybı kullanılır. Amaç kaybı en aza indirmektir , yani kayıp ne kadar küçükse model o kadar iyidir.
